...
def StochasticHillClimbing(board, n, max_iterations=1000, verbose=False):
    steps = 0
    success = False
...
success_rate_StochasticHillClimbing = False
step_count_rate_StochasticHillClimbing_success = 0
step_count_rate_StochasticHillClimbing_failure = 0
step_size = 0.1

for i in range(iterations):
    print('Number of iteration ' + str(i + 1) + ':')
    step_count, success = StochasticHillClimbing(GenerateRandomBoard(n), n, verbose=True)
    if (success):
        print('Success.')
        print('The number of steps are :' + str(step_count))
        step_count_rate_StochasticHillClimbing_success += step_count
    else:
        print('Failure.')
        print('The number of steps are :' + str(step_count))
    step_count_rate_StochasticHillClimbing_failure += step_count
    success_rate_StochasticHillClimbing += success
print('Success rate: ' + str(success_rate_StochasticHillClimbing / iterations))
print('Failure rate: ' + str(1 - (success_rate_StochasticHillClimbing / iterations)))
print('Average steps when success: ' + str(step_count_rate_StochasticHillClimbing_success / success_rate_StochasticHillClimbing))
print('Average steps when failure: ' + str(step_count_rate_StochasticHillClimbing_failure / (iterations - success_rate_StochasticHillClimbing)))